...
public class ValueConstructorExpr extends FunctionExpr {
    ...
    public ValueConstructorExpr(String typeName, String name, List<TypeRef> parameters) {
        super(name, parameters, new TypeRef(new AbstractType(typeName, new ArrayList<>())));
        this.typeName = typeName;
        this.parametricTypes = new ArrayList<>();
    }
