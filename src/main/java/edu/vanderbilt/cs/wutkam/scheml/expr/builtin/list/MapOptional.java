 ...
 */
public class MapOptional extends BuiltinFunctionExpr {
    public MapOptional(String name) {
        super(name, "('a -> option 'b) -> cons 'a -> cons 'b");
    }
    ...
    public Expression executeBuiltin(Expression[] args) throws LispException {
        ...
        while (!curr.constructorName.equals("Nil")) {
            ...
            AbstractTypeExpr result = (AbstractTypeExpr) applyLoop(f, argList);
            if (!result.constructorName.equals("Nothing")) {
                resultStack.push(result.values.get(0));
            }
