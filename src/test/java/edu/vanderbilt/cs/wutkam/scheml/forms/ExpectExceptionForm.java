...
import edu.vanderbilt.cs.wutkam.scheml.expr.ExpectExceptionExpr;
...
public class ExpectExceptionForm implements Form {
    @Override
    public Expression expandForm(ListExpr aList, boolean isTopLevel) throws LispException {
        ...
        return new ExpectExceptionExpr(exceptionName, message, body);
    }
}
